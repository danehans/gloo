...
// indexerByObjType indexes objects based on the provided object type. HTTPRoute, TCPRoute, and ReferenceGrant
// are the only supported object types.
func indexerByObjType(obj client.Object) []string {
	...
	default:
		panic(fmt.Sprintf("wrong type %T provided to indexer. expected HTTPRoute, TCPRoute, or ReferenceGrant", obj))
	}
