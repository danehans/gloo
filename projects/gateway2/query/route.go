...
type RouteInfo struct {
	// Generic route object which could be HTTPRoute, TCPRoute, etc.
	Route client.Object
...
func (r RouteInfo) GetKind() string {
	return r.Route.GetObjectKind().GroupVersionKind().Kind
}
...
func (r *RouteInfo) Hostnames() []string {
	...
	httpRoute, ok := r.Route.(*gwv1.HTTPRoute)
	if !ok {
		return []string{}
	}
